import {addMediaToUser, calculateTotalAge, filterUsersByLocation,} from "./user/user-utils";
import {Media, User} from "./user/user-models";
...
const usersLivingInSameLocation: User[] = filterUsersByLocation(
    userArr,
    "LONDON",
);
